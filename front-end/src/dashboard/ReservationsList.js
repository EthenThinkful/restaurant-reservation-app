  ...
  return (
    <div id="reservation-card">
      ...
      <div className="text-center">
        ...
        {status === "Booked" ? <button type="button"  className="btn btn-secondary mr-3"> <a className="text-light" href={`/reservations/${reservation_id}/seat`}>Seat</a></button> : null}
        {status === "Booked" ? <button type="button" className="btn btn-secondary mr-3"> <a className="text-light" href={`/reservations/${reservation_id}/edit`}>Edit</a> </button> : null}
